...
const DescktopView = () => {
  ...
  return (
    <div className="">
      ...
      <section
        className="md:w-lg h-full flex justify-center mb-10"
        id="decouvrir"
      >
        <div>
          <div className="bg-[#f3f3ff] bg-opacity-60 rounded-xl shadow-lg py-10 px-4 md:h-[50vh] mx-auto md:max-w-screen-xl lg:px-6">
        ...
        <div className="flex justify-center">
          ...
          >
            ...
            >
              ...
              pariatur. Corporis nostrum reiciendis magni mollitia sed ea
              eveniet, voluptatibus unde!
            </TabPanel>
            <TabPanel
              value={1}
              sx={{
